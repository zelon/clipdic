 ...
 */
public class ZUI extends JFrame implements ActionListener
{
	...
	public ZUI() 
	{
		...
		m_rhDicMain = new ClipDicMain(this);
	...
	private javax.swing.JPanel getTopPanel() {
		if(TopPanel == null) {
			...
			TopPanel.add(getJCheckBox(), java.awt.BorderLayout.NORTH);
		}
		return TopPanel;
	}
	/**
	...
	private javax.swing.JButton getJButton() {
		if(jButton == null) {
			...
			jButton.setFont(new Font("굴림체", Font.PLAIN, 12));
	...
	private JCheckBox getJCheckBox() {
		if (jCheckBox == null) {
			...
			jCheckBox.setText("Always On Top");
